...
import { GenerateCertificateDto, CreateCertificateTemplateDto, UpdateCertificateTemplateDto } from './dto/certificates.dto';
...
export class CertificatesController {
  ...
  @Post('templates')
  @Roles('ORG_USER')
  async createTemplate(@Request() req: any, @Body() body: CreateCertificateTemplateDto) {
    return this.certificatesService.createTemplate(req.user.organizationId, body);
  }
  ...
  async getTemplate(@Request() req: any, @Param('id') id: string) {
    return this.certificatesService.getTemplateById(id, req.user.organizationId);
  }

  @Post('templates/:id')
  @Roles('ORG_USER')
  async updateTemplate(@Request() req: any, @Param('id') id: string, @Body() body: UpdateCertificateTemplateDto) {
    return this.certificatesService.updateTemplate(id, req.user.organizationId, body);
  }
  ...
  @Post('request')
  @Roles('STUDENT')
  async requestCertificate(@Request() req: any, @Body() body: GenerateCertificateDto) {
  ...
  async approveCertificate(@Request() req: any, @Body() body: GenerateCertificateDto) {
