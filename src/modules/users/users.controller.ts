...
export class UsersController {
  ...
  @Get('faculty/:id/details')
  @Roles('ORG_USER')
  @ApiOperation({
    summary: 'Get detailed faculty profile including courses and stats',
  })
  async getFacultyDetails(@Request() req: any, @Param('id') facultyId: string) {
    return this.facultyService.getFacultyDetailsForAdmin(
      req.user.organizationId,
      facultyId,
    );
  }
