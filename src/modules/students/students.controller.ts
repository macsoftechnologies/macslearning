...
export class StudentsController {
  ...
  async getStudentDetails(@Request() req: any, @Param('id') studentId: string) {
    const facultyId = req.user.userType === 'FACULTY' ? req.user.userId : undefined;
    return this.studentsService.getDetailedStudentById(
      studentId,
      req.user.organizationId,
      facultyId,
    );
