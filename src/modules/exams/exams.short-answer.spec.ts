...
describe('ExamsService - Short Answer Grading', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getModelToken('AssessmentResult'),
  ...
  it('grades a short answer and updates attempt/result', async () => {
    ...
    const attempt = {
      ...
      studentId: 's1',
      organizationId: 'org1',
      answers: [{ questionId: 'q1', textAnswer: 'answer', isGraded: false }],
      marksObtained: 0,
    ...
    const res = await service.gradeShortAnswer(
      'org1',
      'grader1',
      'e1',
      'a1',
    ...
    expect(mockAttemptModel.findOne).toHaveBeenCalledWith({
      _id: 'a1',
      examId: 'e1',
      organizationId: 'org1',
    });
    expect(mockExamModel.findOne).toHaveBeenCalledWith({
      _id: 'e1',
      organizationId: 'org1',
      isDeleted: false,
    });
