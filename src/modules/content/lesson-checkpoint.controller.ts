...
import {
  CreateLessonCheckpointDto,
  AnswerCheckpointDto,
} from './dto/lesson-checkpoint.dto';
...
export class LessonCheckpointController {
  ...
  async createCheckpoint(
    ...
    return this.contentService.createLessonCheckpoint(
  ...
  async getCheckpoints(
    ...
    return this.contentService.getLessonCheckpoints(
      req.user.organizationId,
      courseId,
      lessonId,
    );
  ...
  async answerCheckpoint(
    ...
    return this.contentService.answerLessonCheckpoint(
      req.user.organizationId,
      req.user.userId,
      courseId,
      lessonId,
  ...
  async getUngraded(
    ...
    return this.contentService.getUngradedCheckpointAnswers(
      req.user.organizationId,
      checkpointId,
    );
  }
  ...
  async gradeAnswer(
    ...
    @Body() body: { marks: number },
  ) {
    return this.contentService.gradeCheckpointAnswer(
      req.user.organizationId,
      req.user.userId,
      answerId,
      body.marks,
